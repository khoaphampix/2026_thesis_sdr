...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--ack-airtime", type=float, default=0.020)
    parser.add_argument("--final-ack-airtime", type=float, default=0.080)
...
def run(args: argparse.Namespace) -> int:
    ...
    logger.info("========== FAST WINDOWED FILE RX ==========")
    ...
    logger.info("========== FAST RX VERIFICATION ==========")
