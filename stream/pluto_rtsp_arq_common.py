#!/usr/bin/env python3
"""Shared protocol for reliable two-Pluto live RTSP H.265 streaming."""
...
# Live-stream control flags.
FLAG_STREAM_START = 0x08
FLAG_STREAM_DATA = 0x10
FLAG_STREAM_STOP = 0x20

# width, height, fps, keyframe interval seconds, target bitrate bit/s
STREAM_INFO_FORMAT = "!HHHHI"
STREAM_INFO_SIZE = struct.calcsize(STREAM_INFO_FORMAT)

# acknowledged HEVC byte count and SHA-256
STREAM_STOP_FORMAT = "!Q32s"
STREAM_STOP_SIZE = struct.calcsize(STREAM_STOP_FORMAT)

# Kept for compatibility with the exact-file ARQ scripts.
